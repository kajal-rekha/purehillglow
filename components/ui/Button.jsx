...
export const buttonVariants = cva(
    "eq inline-block whitespace-nowrap rounded-md border px-2 md:px-4 py-1.5 md:py-2.5  text-center lg:text-[17px] disabled:cursor-default disabled:border-accent disabled:bg-gray disabled:text-black",
    {
        variants: {
            variant: {
                primary:
